...
- `abinnovision/actions/.github/workflows/workflow.yaml@polyglot-monorepo-stack-v1.1`: Targeting minor version <!-- x-release-please-minor -->
- `abinnovision/actions/.github/workflows/workflow.yaml@polyglot-monorepo-stack-v1.1.0`: Targeting a patch version <!-- x-release-please-version -->
