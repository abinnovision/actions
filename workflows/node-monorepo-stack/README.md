...
- `abinnovision/actions/.github/workflows/workflow.yaml@node-monorepo-stack-v1.1`: Targeting minor version <!-- x-release-please-minor -->
- `abinnovision/actions/.github/workflows/workflow.yaml@node-monorepo-stack-v1.1.1`: Targeting a patch version <!-- x-release-please-version -->
...
| `checkout-token`                 | Access token to use for checkout.<br>**Default:** `Github Token`<br>**Note:** PAT requires an expiration date.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | No       | `${{ github.token }}` |
