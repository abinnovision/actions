...
| Output     | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| :--------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `versions` | JSON object mapping released package paths to version info.<br>Each entry contains "version" (semver), "tag" (docker-compatible), and "type" ("release" or "prerelease").<br>Populated for both stable releases and prereleases.<br>Empty object {} when nothing was released or computed.<br>Stable example: {"actions/setup-node": {"version": "1.2.0", "tag": "1.2.0", "type": "release"}}<br>Prerelease example: {"actions/setup-node": {"version": "1.3.0-beta.5+a3f2c1d", "tag": "1.3.0-beta.5-a3f2c1d", "type": "prerelease"}} |
