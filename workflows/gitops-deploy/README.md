...
- `abinnovision/actions/.github/workflows/workflow.yaml@gitops-deploy-v1.0.9`: Targeting a patch version <!-- x-release-please-version -->
...
| `sync-prune`                   | Enable pruning of resources no longer defined in the source.<br>**Note:** When enabled, resources removed from manifests will be deleted during sync                                                                                                                                                                                                                                 | No       | `false`                                                                                                                                 |
